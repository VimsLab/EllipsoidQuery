...
class PointnetSAModuleMSG(_PointnetSAModuleBase):
    ...
    e2 : list of float32
    e3 : list of float32
        list of semi-axis lengths to group with
    ...
    def __init__(
        ...
        super().__init__()
        assert len(e1s) == len(nsamples) == len(mlps)
        self.npoint = npoint
        ...
        for i in range(len(e1s)):
            ...
            self.groupers.append(
                pointnet2_utils.QueryAndGroupE(e1, e2, e3, nsample, use_xyz=use_xyz)
...
if __name__ == "__main__":
    ...
    test_module = PointnetSAModuleMSG(
        npoint=2, e1=[5.0, 10.0], e2=[5.0, 10.0], e3=[5.0, 10.0], nsamples=[6, 3], mlps=[[9, 3], [9, 6]]
    )
    test_module.cuda()
